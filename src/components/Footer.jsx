...
export default function Footer() {
  return (
    <footer className="mt-40">
      <div className="bg-black-gradient-2 rounded-xl py-10 flex items-center justify-evenly mb-20">
      ...
      <div className="flex items-start border-b-[1px] pb-10 border-white/50">
